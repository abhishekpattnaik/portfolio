...
// Remove all previous click event listeners before adding new ones
...
const freshNavLinks = document.querySelectorAll("[data-nav-link]");

// Add event listeners for navigation
freshNavLinks.forEach((link, i) => {
